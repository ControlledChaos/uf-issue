...
$block_title->add_element("PlainTxt", array (
  ...
  array (
    'view_class' => 'PlainTxtView',
    'id_slug' => 'plain_text',
    'content' => '<h5><span class="upfront_theme_bg_color_6" data-verified="redactor" data-redactor-tag="span" data-redactor-class="upfront_theme_bg_color_6">&nbsp;&nbsp;PHOTOGRAPHY &nbsp;</span></h5>',
    'type' => 'PlainTxtModel',
...
$block_title->add_element("Uimage", array (
  ...
  'options' => 
  array (
    'src' => '{{upfront:style_url}}/images/single-page-photography/Issue_Sprites-60x50-3934.png',
    'srcFull' => '{{upfront:style_url}}/images/single-page-photography/Issue_Sprites.png',
    'srcOriginal' => '{{upfront:style_url}}/images/single-page-photography/Issue_Sprites.png',
    'image_title' => '',
    'alternative_text' => '',
