<?php
/* START_REGION_OUTPUT */
$region_edf9a0 = upfront_create_region(
			array (
  'name' => 'header',
  'title' => 'Header',
  'type' => 'clip',
...
$region_edf9a0->add_element("PlainTxt", array (
  'columns' => '2',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
$region_edf9a0->add_element("Unewnavigation", array (
  'columns' => '22',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
    ...
    array (
      ...
      (array)(array(
        ...
        array (
          ...
          (array)(array(
             'menu-item-db-id' => 447,
             'menu-item-parent-id' => '446',
             'menu-item-type' => 'custom',
             'menu-item-title' => 'TV',
             'menu-item-url' => '{{upfront:home_url}}/tv/',
             'menu-item-object' => 'custom',
             'menu-item-object-id' => '447',
             'menu-item-target' => '',
